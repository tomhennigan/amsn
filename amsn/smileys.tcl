...
foreach emot $emotions { 
    if { [lsearch emotion_files [lindex $emot 1]] == -1 } {
	lappend emotion_files [lindex $emot 1]
    }
}
...
proc smile_subst {tw {start "0.0"}} {
  global sortedemotions config smileys_folder smileys_drawn sounds_folder
