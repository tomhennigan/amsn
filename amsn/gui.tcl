...
proc webcampicture {} {
	...
	if { [set ::tcl_platform(platform)] == "windows" } {
		...
		button $window.shot -text "[trans takesnapshot]" -command "webcampicture_shot $window"
		...
		if {![winfo exists $w.shot]} {
			button $w.shot -text "[trans takesnapshot]" -command "webcampicture_shot $w"
			pack $w.shot
		}
...
proc webcampicture_shot {window} {
	...
	button $w.save -text "[trans useasdp]" -command "webcampicture_save $w $preview"
	button $w.saveas -text "[trans saveas]" -command "webcampicture_saveas $w $preview"
