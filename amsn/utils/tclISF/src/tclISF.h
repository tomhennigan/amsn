 ...
 */
EXTERN int tclISF_save _ANSI_ARGS_((ClientData clientData,
        Tcl_Interp *interp,
...
EXTERN ISF_t * getISF_FromTclList _ANSI_ARGS_((Tcl_Interp *interp, Tcl_Obj ** strokes_vector, int strokes_counter));
