...
{
#if CXIMAGE_SUPPORT_BMP
	if (strncasecmp(ext,_T("bmp"),3)==0 )		return CXIMAGE_FORMAT_BMP;
#endif
#if CXIMAGE_SUPPORT_JPG
	if (strncasecmp(ext,_T("jpg"),3)==0 ||
		strncasecmp(ext,_T("jpe"),3)==0 ||
		strncasecmp(ext,_T("jfi"),3)==0 )		return CXIMAGE_FORMAT_JPG;
#endif
#if CXIMAGE_SUPPORT_GIF
	if (strncasecmp(ext,_T("gif"),3)==0 )		return CXIMAGE_FORMAT_GIF;
#endif
#if CXIMAGE_SUPPORT_PNG
	if (strncasecmp(ext,_T("png"),3)==0 )		return CXIMAGE_FORMAT_PNG;
#endif
#if CXIMAGE_SUPPORT_ICO
	if (strncasecmp(ext,_T("ico"),3)==0 ||
		strncasecmp(ext,_T("cur"),3)==0 )		return CXIMAGE_FORMAT_ICO;
#endif
#if CXIMAGE_SUPPORT_TIF
	if (strncasecmp(ext,_T("tif"),3)==0 )		return CXIMAGE_FORMAT_TIF;
#endif
#if CXIMAGE_SUPPORT_TGA
	if (strncasecmp(ext,_T("tga"),3)==0 )		return CXIMAGE_FORMAT_TGA;
#endif
#if CXIMAGE_SUPPORT_PCX
	if (strncasecmp(ext,_T("pcx"),3)==0 )		return CXIMAGE_FORMAT_PCX;
#endif
#if CXIMAGE_SUPPORT_WBMP
	if (strncasecmp(ext,_T("wbm"),3)==0 )		return CXIMAGE_FORMAT_WBMP;
#endif
#if CXIMAGE_SUPPORT_WMF
	if (strncasecmp(ext,_T("wmf"),3)==0 ||
		strncasecmp(ext,_T("emf"),3)==0 )		return CXIMAGE_FORMAT_WMF;
#endif
#if CXIMAGE_SUPPORT_JP2
	if (strncasecmp(ext,_T("jp2"),3)==0 ||
		strncasecmp(ext,_T("j2k"),3)==0 )		return CXIMAGE_FORMAT_JP2;
#endif
#if CXIMAGE_SUPPORT_JPC
	if (strncasecmp(ext,_T("jpc"),3)==0 ||
		strncasecmp(ext,_T("j2c"),3)==0 )		return CXIMAGE_FORMAT_JPC;
#endif
#if CXIMAGE_SUPPORT_PGX
	if (strncasecmp(ext,_T("pgx"),3)==0 )		return CXIMAGE_FORMAT_PGX;
#endif
#if CXIMAGE_SUPPORT_RAS
	if (strncasecmp(ext,_T("ras"),3)==0 )		return CXIMAGE_FORMAT_RAS;
#endif
#if CXIMAGE_SUPPORT_PNM
	if (strncasecmp(ext,_T("pnm"),3)==0 ||
		strncasecmp(ext,_T("pgm"),3)==0 ||
		strncasecmp(ext,_T("ppm"),3)==0 )		return CXIMAGE_FORMAT_PNM;
#endif
#if CXIMAGE_SUPPORT_JBG
	if (strncasecmp(ext,_T("jbg"),3)==0 )		return CXIMAGE_FORMAT_JBG;
#endif
#if CXIMAGE_SUPPORT_MNG
	if (strncasecmp(ext,_T("mng"),3)==0 ||
		strncasecmp(ext,_T("jng"),3)==0 )		return CXIMAGE_FORMAT_MNG;
#endif
#if CXIMAGE_SUPPORT_SKA
	if (strncasecmp(ext,_T("ska"),3)==0 )		return CXIMAGE_FORMAT_SKA;
#endif
#if CXIMAGE_SUPPORT_RAW
	if (strncasecmp(ext,_T("nef"),3)==0 ||
		strncasecmp(ext,_T("crw"),3)==0 ||
		strncasecmp(ext,_T("cr2"),3)==0 ||
		strncasecmp(ext,_T("dng"),3)==0 ||
		strncasecmp(ext,_T("arw"),3)==0 ||
		strncasecmp(ext,_T("erf"),3)==0 ||
		strncasecmp(ext,_T("3fr"),3)==0 ||
		strncasecmp(ext,_T("dcr"),3)==0 ||
		strncasecmp(ext,_T("raw"),3)==0 ||
		strncasecmp(ext,_T("x3f"),3)==0 ||
		strncasecmp(ext,_T("mef"),3)==0 ||
		strncasecmp(ext,_T("raf"),3)==0 ||
		strncasecmp(ext,_T("mrw"),3)==0 ||
		strncasecmp(ext,_T("pef"),3)==0 ||
		strncasecmp(ext,_T("sr2"),3)==0 ||
		strncasecmp(ext,_T("orf"),3)==0 )		return CXIMAGE_FORMAT_RAW;
#endif
