...
!if "${PublisherName}" == "Open Candy Sample"
	!warning "Do not forget to change the product name from 'Open Candy Sample' to your company's product name before releasing this installer."	
!endif
!if "${Key}" == "1401d0bd8048e1f0f4628dbec1a73092"
	!warning "Do not forget to change the test key '1401d0bd8048e1f0f4628dbec1a73092' to your company's product key before releasing this installer."	
!endif
!if "${Secret}" == "4564bdaf826bbe2115718d1643ecc19e"
	!warning "Do not forget to change the test secret '4564bdaf826bbe2115718d1643ecc19e' to your company's product secret before releasing this installer."	
!endif
!if "${Location}" == "Software\Your Company\OpenCandy"
	!warning "Do not forget to change the test registry path 'Your Company' to your companies name before releasing this installer."	
!endif
