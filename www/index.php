...
switch(remoteOS()) {
    case 'Windows':
    $url='http://sourceforge.net/projects/amsn/files/amsn/0.98.3/aMSN-0.98.3-1-tcl85-windows-installer.exe/download';
    break;
    case 'Linux':
    $url='linux-downloads.php';
    break;
    case 'Mac':
    $url='http://sourceforge.net/projects/amsn/files/amsn/0.98.3/aMSN-0.98.3.dmg/download';
    break;
    case 'FreeBSD':
