...
if (!isset($actual)) {
    ...
    echo '<a href="screenshots/screen_' . basename($actual['screen']) . '"><img src="showimage.php?file=screenshots/screen_' . basename($actual['screen']) . '&amp;width=550" id="screenshot_img" alt="' . htmlentities(stripslashes($actual['name'])) . '" class="screenshot"/></a>';
