...
* @hacker    Karol Krizka <kkrizka@gmail.com>
...
class XML
{
    ...
    *
    * This constructor initializes the class and, when text is given,
    * tries to  parse it.
    *
    * @access    public
    * @author    Michael P. Mehl <mpm@phpxml.org>
   ...
   * Parses the XML data.
   *
   * This method reads the content of a XML text, tries to parse its
   * content and upon success stores the information retrieved from
   * the file into an array.
   *
   * @access    public
  ...
  function load_text($text) {
    ...
    */
    function handle_character_data ( $parser, $text )
    {
        ...
        // Save the text.
        $this->add_content($this->path, addslashes($text));
    }
