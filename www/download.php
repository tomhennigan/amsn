...
<!--            <li><a href="http://www.freshports.org/net/amsn/" class="screeny"><img class="thumb" src="images/download-freebsd.png" alt="Screenshot" /></a><br />FreeBSD</li>-->
            <li><a href="http://prdownloads.sourceforge.net/amsn/amsn-0.95-windows-installer-2.exe" class="screeny"><img class="thumb" src="images/download-windows.png" alt="Screenshot" /></a><br />Windows</li>
