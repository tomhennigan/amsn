   ...
   <div class="IEFixPNG" id="screenshots">
    <ul><li>
     <ul>
       ...
       <li><a href="http://prdownloads.sourceforge.net/amsn/amsn-0-97-final2.dmg" class="screeny"><img class="thumb" src="images/download-macosx.png" alt="MacOSX" /></a><br />Mac OS X  (Universal)</li>
