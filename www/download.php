   ...
   <div class="IEFixPNG" id="screenshots">
    <ul><li>
     <ul>
       ...
       <li><a href="http://prdownloads.sourceforge.net/amsn/aMSN-0.97.1-windows-installer.exe" class="screeny"><img class="thumb" src="images/download-windows.png" alt="Windows" /></a><br />Windows</li>
       <li><a href="http://prdownloads.sourceforge.net/amsn/amsn-0.97.1-1.dmg" class="screeny"><img class="thumb" src="images/download-macosx.png" alt="MacOSX" /></a><br />Mac OS X  (Universal)</li>
       ...
       <li><a href="http://prdownloads.sourceforge.net/amsn/amsn-0.97.1.tar.bz2" class="screeny"><img class="thumb" src="images/download-tarball.png" alt="Tarball" /></a><br />Tarball Source</li>
     </ul>
    </li>
    <li>
