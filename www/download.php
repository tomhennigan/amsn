...
<li><a href="http://sourceforge.net/projects/amsn/files/amsn/0.98.1/aMSN-0.98.1-1-tcl85-windows-installer.exe/download" class="screeny"><img class="thumb" src="images/download-windows.png" alt="Windows" ></a><br ><?=WIN_DOWN;?></li>
<li><a href="http://sourceforge.net/projects/amsn/files/amsn/0.98.1/aMSN-0.98.1-1-tcl84-windows-installer.exe/download" class="screeny"><img class="thumb" src="images/download-windows.png" alt="Windows" ></a><br><?=WIN95_DOWN;?></li>
