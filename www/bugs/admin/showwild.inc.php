<?php
$table=new Tabler(TBUGREPORTS,array('ID'=>'bug_id','Text'=>'bug_text','Submitted'=>'bug_date','Revision'=>'bug_revision','CVS Date'=>'bug_cvsdate','Version'=>'bug_amsn','Tcl/TK'=>'bug_tcl','OS'=>'bug_os','MSN Protocol'=>'bug_msnprotocol'),array('bug_parent=0'));
