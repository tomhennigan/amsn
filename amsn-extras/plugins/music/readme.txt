...
Currently, the Music plugin supports many players : ITunes (Mac), WinAmp, Windows Media Player (Windows), Amarok, Audacious, Banshee, Exaile, Juk, Listen, MPD, QuodLibet, Rhythmbox, Totem and XMMS (Linux).
...
WinAmp :
- Normally it's like ITunes : it works immediatly.

Windows Media Player :
- You need MSN Messenger installed and its plugin enabled in WMP

XMMS :
It's a little more complicated than the others (just a little ;))
